...
func sendCtrlC(t *testing.T, pid int) {
	...
	//
	// ?   	github.com/open-cmsis-pack/generator-bridge/cmd	[no test files]
	// ?   	github.com/open-cmsis-pack/generator-bridge/cmd/commands	[no test files]
	// ?   	github.com/open-cmsis-pack/generator-bridge/cmd/errors	[no test files]
	...
	// +     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	// [DBG]: PS D:\a\generator-bridge\generator-bridge>>
